...
function update(req, resp, next) {
    if (req.params.id) {
        ...
        const queryUpdateAlumno = 'UPDATE alumnos SET cuatrimestre = ?, matricula = ?, nombre = ?, apellido_paterno = ?, apellido_materno = ?, genero = ?, fecha_nacimiento = ?, id_domicilio = ? WHERE id = ?';
